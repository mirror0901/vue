    ...
    <el-container>
      ...
      <el-main style="padding-left: 0px;padding-top: 0px">
        ...
        <div style="text-align: left;margin-top: 10px" v-if="salaries!=0">
          <el-button type="danger" round size="mini" :disabled="multipleSelection.length==0" @click="deleteAll">
            批量删除
          </el-button>
        </div>
      </el-main>
    ...
    <div style="text-align: left">
      <el-dialog
        ...
        <div style="display: block;justify-content: flex-start;">
          <el-steps :active="index" direction="horizontal">
  ...
  export default {
    ...
    methods: {
      ...
      next () {
        let _this = this
        if (this.index == 7) {
          if (this.salary.createDate && this.salary.basicSalary
            && this.salary.trafficSalary && this.salary.lunchSalary
            && this.salary.bonus && this.salary.pensionBase
            && this.salary.pensionPer && this.salary.medicalBase
            && this.salary.medicalPer && this.salary.accumulationFundBase
