    ...
    <div style="text-align: left">
      <el-dialog
        ...
        <span slot="footer" class="dialog-footer">
          ...
          <el-button type="primary" size="mini" @click="updatePosNameExec">确定</el-button>
        </span>
      </el-dialog>
    </div>
  </div>
    ...
    methods: {
      updatePosNameExec () {
        ...
        this.putRequest(this.state === 'position' ? '/system/basic/position' : '/system/basic/joblevel',
          {name: this.updatePosName, id: this.updatePosId, titleLevel: this.updateTitleLevel}).then(resp => {
          _this.loading = false
